...
TIMES="10"
CHATID="5737116940"
KEY="6614595445:AAEvO3Q49VkCWfENWDXvn0kiK2gFGDF7PCI"
...
echo -e "  Auther : ${green}Kuroko-Vpn® ${NC}${YELLOW}(${NC} ${green} Kuroko-vpn${NC}${YELLOW})${NC}"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/88PanelSc/Regist/MONSTER/afk | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/88PanelSc/Regist/MONSTER/afk | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/88PanelSc/Regist/MONSTER/afk | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/88PanelSc/wiz4rd/MONSTER/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/88PanelSc/Regist/MONSTER/afk | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/88PanelSc/Regist/MONSTER/afk | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://t.me/asslamulaikumpalestina6"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/asslamulaikumpalestina6"}]]}'
